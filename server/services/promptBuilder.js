/**
 * 提示词构建服务 — 全部业务逻辑在服务端
 * 参照 通用学科-教学设计参考模板.html 严格构建
 */

/**
 * 根据教案表单数据构建完整的 AI 提示词
 * @param {Object} formData - 前端提交的表单数据
...
function buildPrompt(formData) {
  ...
  prompt +=
    '<!-- 教学实施 -->\n' +
    '<tr>\n' +
    '  <td class="label-cell section-title" colspan="6" style="text-align:center;font-weight:bold;background-color:#f5f5f5;">教 学 实 施</td>\n' +
    '</tr>\n' +
    '<tr>\n' +
